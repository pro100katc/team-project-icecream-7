...
var _modalContacts = require("./js/modal-contacts");
...
},{"./js/modal":"aHHgN","./js/mobile-menu":"gWx5g","./js/slick":"5GXNQ","./js/modal-contacts":"8d2Er","./js/products-modal":"eUPbQ","./js/about-modal":"a2ZJK","./js/scroll":"55W1t","./js/modal-mobile":"2nEsq"}],"aHHgN":[function(require,module,exports) {
(()=>{
    const refs = {
...
},{}],"8d2Er":[function(require,module,exports) {
(()=>{
    const refs = {
...
(()=>{
    const refs = {
        openProductsModalPinkBtn: document.querySelector("[data-products-modal-pink-open]"),
        closeProductsModalPinkBtn: document.querySelector("[data-products-modal-pink-close]"),
        productsModalPink: document.querySelector("[data-products-modal-pink]")
    };
    refs.openProductsModalPinkBtn.addEventListener("click", toggleProductsModalPink);
    refs.closeProductsModalPinkBtn.addEventListener("click", toggleProductsModalPink);
...
(()=>{
    const refs = {
        openProductsModalYellowBtn: document.querySelector("[data-products-modal-yellow-open]"),
        closeProductsModalYellowBtn: document.querySelector("[data-products-modal-yellow-close]"),
        productsModalYellow: document.querySelector("[data-products-modal-yellow]")
    };
    refs.openProductsModalYellowBtn.addEventListener("click", toggleProductsModalYellow);
    refs.closeProductsModalYellowBtn.addEventListener("click", toggleProductsModalYellow);
...
(()=>{
    const refs = {
        openProductsModalGreenBtn: document.querySelector("[data-products-modal-green-open]"),
        closeProductsModalGreenBtn: document.querySelector("[data-products-modal-green-close]"),
        productsModalGreen: document.querySelector("[data-products-modal-green]")
    };
    refs.openProductsModalGreenBtn.addEventListener("click", toggleProductsModalGreen);
    refs.closeProductsModalGreenBtn.addEventListener("click", toggleProductsModalGreen);
...
(0, _jqueryDefault.default)(document).ready(function() {
    ...
    (0, _jqueryDefault.default)("a").on("click", function(event) {
